...
-- 기존 데이터 삭제
TRUNCATE TABLE public.endings RESTART IDENTITY CASCADE;
...
-- Ending 시드 데이터
-- --------------------------------------------------------------------
INSERT INTO endings (id, code, title, content, condition, image_id, created_at, updated_at) VALUES
...
-- NPC 시드 데이터
-- --------------------------------------------------------------------
INSERT INTO npc (id, code, name, tags, image_id, created_at, updated_at) VALUES
